...
namespace GoTravel.API.Migrations
{
    ...
    [Migration("20231226211850_LineBrandingColour")]
    partial class LineBrandingColour
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GLFlagGLLineMode", b =>
                {
                    ...
                    b.Property<string>("GLLineModeLineModeName")
                        .HasColumnType("text");

                    b.HasKey("FlagsGLFlagId", "GLLineModeLineModeName");

                    b.HasIndex("GLLineModeLineModeName");
            ...
            modelBuilder.Entity("GLFlagGLLineMode", b =>
                {
                    ...
                    b.HasOne("GoTravel.API.Domain.Models.Database.GLLineMode", null)
                        .WithMany()
                        .HasForeignKey("GLLineModeLineModeName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
